...
- [X] [100%] Telemetry and messaging protocol.
- [X] [100%] Aircraft modelling, control system design and implementation.
- [X] [100%] Higher-level firmware (state machine, guidance algorithms, etc.)
- [X] [100%] Low-level firmware (e.g. device drivers and interfaces).
- [X] [100%] State Estimation (Madgwick & Kalman filters).

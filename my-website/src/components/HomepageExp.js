...
const ExperienceList = [
  {
    title: "HBM Digital Design Sr Engineer",
    Svg: require("../../static/img/synopsys.svg").default,
    description: <>Jan 2024 - Present</>,
  },
  {
    title: "SERDES Digital Design Engineer I/II",
    Svg: require("../../static/img/synopsys.svg").default,
    description: <>May 2022 - Dec 2023</>,
  },
  {
    title: "HBM Verification Engineer Intern",
    Svg: require("../../static/img/synopsys.svg").default,
    description: <>Jan 2021 - May 2022</>,
  },
  {
    title: "ASIC Digital Verification Engineer CO-OP",
    Svg: require("../../static/img/ciena.svg").default,
    description: <>Jan 2020 - July 2020</>,
  },
  {
